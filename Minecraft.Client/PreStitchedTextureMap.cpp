...
void PreStitchedTextureMap::loadUVs()
{
	...
	if(iconType != Icon::TYPE_TERRAIN)
	{
		...
		ADD_ICON(18,		8,	L"zaniteHoe")
		ADD_ICON(18,		9,	L"zaniteGemstone")
		ADD_ICON(18,		10,	L"ambrosiumShard")
		ADD_ICON(18,		11,	L"goldenAmber")
		ADD_ICON(18,		12,	L"swetBall")
		ADD_ICON(18,		13,	L"aechorPetal")
		ADD_ICON(18,		14,	L"blueBerry")
		ADD_ICON(18,		15,	L"blueBerryEnchanted")
