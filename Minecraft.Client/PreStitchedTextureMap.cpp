...
void PreStitchedTextureMap::loadUVs()
{
	...
	if(iconType != Icon::TYPE_TERRAIN)
	{
		...
		ADD_ICON(16,		0,	L"nethanium_helmet")
		ADD_ICON(16,		1,	L"nethanium_chestplate")
		ADD_ICON(16,		2,	L"nethanium_leggings")
		ADD_ICON(16,		3,	L"nethanium_boots")
		ADD_ICON(16,		4,	L"nethaniumSword")
		ADD_ICON(16,		5,	L"nethaniumAxe")
		ADD_ICON(16,		6,	L"nethaniumPickaxe")
		ADD_ICON(16,		7,	L"nethaniumShovel")
		ADD_ICON(16,		8,	L"nethaniumHoe")
		ADD_ICON(16,		9,	L"nethanium")
		ADD_ICON(16,		10,	L"relicMallet")
		ADD_ICON(16,		11,	L"netherStaff")
		ADD_ICON(16,		12,	L"aphalafSword")
		ADD_ICON(16,		13,	L"netherwartBread")
		ADD_ICON(16,		14,	L"netherwartBreadGold")
		ADD_ICON(16,		15,	L"netherwartBreadNethanium")

		ADD_ICON(17,		0,	L"endorium_helmet")
		ADD_ICON(17,		1,	L"endorium_chestplate")
		ADD_ICON(17,		2,	L"endorium_leggings")
		ADD_ICON(17,		3,	L"endorium_boots")
		ADD_ICON(17,		4,	L"endoriumSword")
		ADD_ICON(17,		5,	L"endoriumAxe")
		ADD_ICON(17,		6,	L"endoriumPickaxe")
		ADD_ICON(17,		7,	L"endoriumShovel")
		ADD_ICON(17,		8,	L"endoriumHoe")
		ADD_ICON(17,		9,	L"endorium")
		ADD_ICON(17,		10,	L"evupulWing")
		ADD_ICON(17,		11,	L"evupulWing_gold")
		ADD_ICON(17,		12,	L"aphalafTooth")
		ADD_ICON(17,		13,	L"isogalRib")
		ADD_ICON(17,		14,	L"veloettBerry")
		ADD_ICON(17,		15,	L"hellsphere")

		ADD_ICON(18,		0,	L"elytra")
		ADD_ICON(18,		1,	L"elytra_broken")
		ADD_ICON(18,		2,	L"elytra_gold")
		ADD_ICON(18,		3,	L"elytra_gold_broken")
		ADD_ICON(18,		4,	L"endothaniumSword")
		ADD_ICON(18,		5,	L"endothaniumAxe")
		ADD_ICON(18,		6,	L"endothaniumPickaxe")
		ADD_ICON(18,		7,	L"endothaniumShovel")
		ADD_ICON(18,		8,	L"endothaniumHoe")
		ADD_ICON(18,		9,	L"endothanium")
		ADD_ICON(18,		10,	L"staffShard")
		ADD_ICON(18,		11,	L"aphalafShard")
		ADD_ICON(18,		12,	L"aphalafRod")
		ADD_ICON(18,		13,	L"nusaShard")
		ADD_ICON(18,		14,	L"nusaArmor")
		ADD_ICON(18,		15,	L"nusaBlade")

		ADD_ICON(19,		0,	L"zanite_helmet")
		ADD_ICON(19,		1,	L"zanite_chestplate")
		ADD_ICON(19,		2,	L"zanite_leggings")
		ADD_ICON(19,		3,	L"zanite_boots")
		ADD_ICON(19,		4,	L"zaniteSword")
		ADD_ICON(19,		5,	L"zaniteAxe")
		ADD_ICON(19,		6,	L"zanitePickaxe")
		ADD_ICON(19,		7,	L"zaniteShovel")
		ADD_ICON(19,		8,	L"zaniteHoe")
		ADD_ICON(19,		9,	L"zaniteGemstone")
		ADD_ICON(19,		10,	L"ambrosiumShard")
		ADD_ICON(19,		11,	L"goldenAmber")
		ADD_ICON(19,		12,	L"swetBall")
		ADD_ICON(19,		13,	L"aechorPetal")
		ADD_ICON(19,		14,	L"blueBerry")
		ADD_ICON(19,		15,	L"blueBerryEnchanted")

		ADD_ICON(20,		0,	L"gravitite_helmet")
		ADD_ICON(20,		1,	L"gravitite_chestplate")
		ADD_ICON(20,		2,	L"gravitite_leggings")
		ADD_ICON(20,		3,	L"gravitite_boots")
		ADD_ICON(20,		4,	L"gravititeSword")
		ADD_ICON(20,		5,	L"gravititeAxe")
		ADD_ICON(20,		6,	L"gravititePickaxe")
		ADD_ICON(20,		7,	L"gravititeShovel")
		ADD_ICON(20,		8,	L"gravititeHoe")
		ADD_ICON(20,		9,	L"regenerationStone")
		ADD_ICON(20,		10,	L"lifeShard")
		ADD_ICON(20,		11,	L"healingStone")
		ADD_ICON(20,		12,	L"cloudStaff")
		ADD_ICON(20,		13,	L"pigSlayer")
		ADD_ICON(20,		14,	L"vampireSword")
		ADD_ICON(20,		15,	L"lightningKnife")

		ADD_ICON(21,		0,	L"skyrootBucket_empty")
		ADD_ICON(21,		1,	L"skyrootBucket_water")
		ADD_ICON(21,		2,	L"skyrootBucket_milk")
		ADD_ICON(21,		3,	L"skyrootBucket_poison")
		ADD_ICON(21,		4,	L"skyrootSword")
		ADD_ICON(21,		5,	L"skyrootAxe")
		ADD_ICON(21,		6,	L"skyrootPickaxe")
		ADD_ICON(21,		7,	L"skyrootShovel")
		ADD_ICON(21,		8,	L"skyrootHoe")
		ADD_ICON(21,		9,	L"goldenFeather")
		ADD_ICON(21,		10,	L"cloudParachute")
		ADD_ICON(21,		11,	L"gummySwetBlue")
		ADD_ICON(21,		12,	L"gummySwetGold")
		ADD_ICON(21,		13,	L"moaEggWhite")
		...
		ADD_ICON(22,		7,	L"holystoneShovel")
		ADD_ICON(22,		8,	L"holystoneHoe")
		ADD_ICON(22,		9,	L"dartGold")
		ADD_ICON(22,		10,	L"dartPoison")
		ADD_ICON(22,		11,	L"dartEnchanted")
		...
		ADD_ICON(23,		2,	L"valkyrie_leggings")
		ADD_ICON(23,		3,	L"valkyrie_boots")
		ADD_ICON(23,		4,	L"valkyrieLance")
		ADD_ICON(23,		5,	L"valkyrieAxe")
		ADD_ICON(23,		6,	L"valkyriePickaxe")
		ADD_ICON(23,		7,	L"valkyrieShovel")
		ADD_ICON(23,		8,	L"valkyrieHoe")
		ADD_ICON(23,		9,	L"keyBronze")
		ADD_ICON(23,		10,	L"keySilver")
		ADD_ICON(23,		11,	L"keyGold")
		ADD_ICON(23,		12,	L"phoenixBow")
		...
		ADD_ICON(24,		10,	L"icePendant")
		ADD_ICON(24,		11,	L"iceRing")
		ADD_ICON(24,		12,	L"gravititePendant")
		ADD_ICON(24,		13,	L"gravititeRing")
		ADD_ICON(24,		14,	L"dartNethanium")
		ADD_ICON(24,		15,	L"dartShooterNethanium")
	...
	ADD_ICON(18,	0,	L"nether_log_top");
	ADD_ICON(18,	1,	L"planks_nether");
	ADD_ICON(18,	2,	L"nether_vine");
	ADD_ICON(18,	3,	L"nether_bricks_mossy");
	ADD_ICON(18,	4,	L"nethanium_ore");
	ADD_ICON(18,	5,	L"nethanium_block");
	ADD_ICON(18,	6,	L"sapling_nether");
	ADD_ICON(18,	7,	L"nether_furnace_top");
	ADD_ICON(18,	8,	L"nether_furnace_side");
	ADD_ICON(18,	9,	L"nether_furnace_front");
	ADD_ICON(18,	10,	L"nether_furnace_front_lit");
	ADD_ICON(18,	11,	L"end_stone_bricks");
	ADD_ICON(18,	12,	L"end_stone_chiseled");
	ADD_ICON(18,	13,	L"end_stone_smooth");
	ADD_ICON(18,	14,	L"end_stone_mossy");
	ADD_ICON(18,	15,	L"end_stone_bricksMossy");

	ADD_ICON(19,	0,	L"veloett_grass_side");
	ADD_ICON(19,	1,	L"veloett_grass_top");
	ADD_ICON(19,	2,	L"end_sand");
	ADD_ICON(19,	3,	L"endorium_ore");
	ADD_ICON(19,	4,	L"endorium_block");
	ADD_ICON(19,	5,	L"endorium_grate");
	ADD_ICON(19,	6,	L"endorium_lamp");
	ADD_ICON(19,	7,	L"purul_veloett");
	ADD_ICON(19,	8,	L"purul_log_side");
	ADD_ICON(19,	9,	L"purul_log_top");
	ADD_ICON(19,	10,	L"planks_nether_purul");
	ADD_ICON(19,	11,	L"endactus_side");
	ADD_ICON(19,	12,	L"endactus_top");
	ADD_ICON(19,	13,	L"endactus_bottom");
	ADD_ICON(19,	14,	L"endesert_bush");
	ADD_ICON(19,	15,	L"veloett_shrub");

	ADD_ICON(20,	0,	L"veloett_flower");
	ADD_ICON(20,	1,	L"veloett_vine");
	ADD_ICON(20,	2,	L"melon_carved");
	ADD_ICON(20,	3,	L"melon_lit");
	ADD_ICON(20,	4,	L"packed_ice");
	ADD_ICON(20,	5,	L"blue_ice");
	ADD_ICON(20,	6,	L"packed_glass");
	ADD_ICON(20,	7,	L"prismarine");
	ADD_ICON(20,	8,	L"prismarineBricks");
	ADD_ICON(20,	9,	L"prismarineDark");
	ADD_ICON(20,	10,	L"seaLantern");
	ADD_ICON(20,	11,	L"slimeBlock");
	ADD_ICON(20,	12,	L"barrier");
	ADD_ICON(20,	13,	L"ironTrapdoor");
	ADD_ICON(20,	14,	L"stainedGlass");
	ADD_ICON(20,	15,	L"stainedGlass_top");

	ADD_ICON(21,	0,	L"aercloud");
	ADD_ICON(21,	1,	L"aerogel");
	ADD_ICON(21,	2,	L"aetherDirt");
	ADD_ICON(21,	3,	L"aetherGrass_side");
	ADD_ICON(21,	4,	L"aetherGrass_top");
	ADD_ICON(21,	5,	L"holystone");
	ADD_ICON(21,	6,	L"holystone_mossy");
	ADD_ICON(21,	7,	L"ambrosiumOre");
	ADD_ICON(21,	8,	L"gravititeOre");
	ADD_ICON(21,	9,	L"zaniteOre");
	ADD_ICON(21,	10,	L"carvedStone");
	ADD_ICON(21,	11,	L"carvedStone_light");
	ADD_ICON(21,	12,	L"angelicStone");
	ADD_ICON(21,	13,	L"angelicStone_light");
	ADD_ICON(21,	14,	L"hellfireStone");
	ADD_ICON(21,	15,	L"hellfireStone_light");

	ADD_ICON(22,	0,	L"icestone");
	ADD_ICON(22,	1,	L"quicksoil");
	ADD_ICON(22,	2,	L"quicksoilGlass");
	ADD_ICON(22,	3,	L"pillar_top");
	ADD_ICON(22,	4,	L"pillar_side");
	ADD_ICON(22,	5,	L"pillar_carved");
	ADD_ICON(22,	6,	L"skyrootLog_side");
	ADD_ICON(22,	7,	L"skyrootLog_top");
	ADD_ICON(22,	8,	L"planks_nether_skyroot");
	ADD_ICON(22,	9,	L"skyrootLeaves");
	ADD_ICON(22,	10,	L"skyrootSapling");
	ADD_ICON(22,	11,	L"goldenOakLog_side");
	ADD_ICON(22,	12,	L"goldenOakLeaves");
	ADD_ICON(22,	13,	L"goldenOakSapling");
	ADD_ICON(22,	14,	L"flower_purple");
	ADD_ICON(22,	15,	L"flower_white");

	ADD_ICON(23,	0,	L"skyrootBookshelf_side");
	ADD_ICON(23,	1,	L"incubator_top");
	ADD_ICON(23,	2,	L"enchanter_top");
	ADD_ICON(23,	3,	L"incubator_side");
	ADD_ICON(23,	4,	L"enchanter_side");
	ADD_ICON(23,	5,	L"freezer_side");
	ADD_ICON(23,	6,	L"freezer_top");
	ADD_ICON(23,	7,	L"treasureChest_front");
	ADD_ICON(23,	8,	L"treasureChest_side");
	ADD_ICON(23,	9,	L"ambrosiumTorch");
	ADD_ICON(23,	10,	L"berryBushStem");
	ADD_ICON(23,	11,	L"berryBush");
	ADD_ICON(23,	12,	L"holidayLeaves");
	ADD_ICON(23,	13,	L"holidayLeavesDecorated");
	ADD_ICON(23,	14,	L"sunAltar_top");
	ADD_ICON(23,	15,	L"sunAltar_side");

	ADD_ICON(24,	0,	L"holystoneBricks");
	ADD_ICON(24,	1,	L"zaniteBlock");
	ADD_ICON(24,	2,	L"ambrosiumBlock");

	ADD_ICON(25,	0,	L"nethaniumFurnce_top");
