...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM(Tile::mycel_Id)
		ITEM(Tile::dirt_Id)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_DEFAULT)
		...
		ITEM(Tile::endothaniumBlock_Id)
		ITEM(Tile::ambrosiumBlock_Id)
		...
		ITEM_AUX(Tile::goldenclin_Id, GoldenclinTile::TYPE_DEFAULT)
		ITEM_AUX(Tile::goldenclin_Id, GoldenclinTile::TYPE_BRICK)
		...
		ITEM_AUX(Tile::endStone_Id, EndStoneTile::TYPE_DEFAULT)
		ITEM_AUX(Tile::endStone_Id, EndStoneTile::TYPE_MOSSY)
		ITEM_AUX(Tile::endStone_Id, EndStoneTile::TYPE_SMOOTH)
		ITEM_AUX(Tile::endStone_Id, EndStoneTile::TYPE_BRICK)
		...
		ITEM_AUX(Tile::netherPlanks_Id,NetherPlanksTile::TYPE_DEFAULT)
		ITEM_AUX(Tile::netherPlanks_Id,NetherPlanksTile::TYPE_PURUL)
		ITEM_AUX(Tile::netherPlanks_Id,NetherPlanksTile::TYPE_SKYROOT)
		ITEM_AUX(Tile::netherPlanks_Id,NetherPlanksTile::TYPE_NUSA)
		...
		ITEM(Tile::nusaLog_Id)

		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_NORMAL)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_SPRUCE)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_BIRCH)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_JUNGLE)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_NETHER)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_PURUL)
		ITEM_AUX(Tile::fence_Id, FenceTile::TYPE_SKYROOT)
		ITEM(Tile::netherFence_Id)

		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::OAK_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::SPRUCE_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::BIRCH_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::JUNGLE_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::NETHER_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::PURUL_SLAB)
		ITEM_AUX(Tile::woodSlabHalf_Id,WoodSlabTile::SKYROOT_SLAB)
		...
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::NETHERBRICK_MOSSY_SLAB)
		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::QUARTZ_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::GOLDENCLIN_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::GOLDENCLINBRICK_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::ENDSTONE_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::ENDSTONE_MOSSY_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::ENDBRICK_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::ENDBRICK_MOSSY_SLAB)
		ITEM_AUX(Tile::stoneSlab2Half_Id,StoneSlab2Tile::HOLYSTONE_BRICK_SLAB)
		...
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_STONEBRICK)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_GOLDENCLIN)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_GOLDENCLINBRICK)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_QUARTZ)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_BRICK)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_NETHERBRICK)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_NETHERBRICK_MOSSY)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_ENDSTONE)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_ENDSTONE_MOSSY)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_ENDBRICK)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_ENDBRICK_MOSSY)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_HOLYSTONE)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_HOLYSTONE_MOSSY)
		ITEM_AUX(Tile::cobbleWall_Id, WallTile::TYPE_HOLYSTONE_BRICK)
	...
	DEF(eCreativeInventory_Decoration)
		...
		ITEM_AUX(Tile::leaves_Id, LeafTile::PURPLE_LEAF)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_DEFAULT)
			ITEM(Tile::purulVeloett_Id)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_SKYROOT)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_GOLDENOAK)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_HOLIDAY)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_HOLIDAY_FANCY)
			ITEM_AUX(Tile::netherLeaves_Id, NetherLeavesTile::TYPE_BERRY)
		...
		ITEM_AUX(Tile::flower_Id, FlowerTile::YELLOW)
			...
			ITEM_AUX(Tile::flower_Id, FlowerTile::PURPLE)
		...
		ITEM_AUX(Tile::glass_Id,GlassTile::TYPE_DEFAULT)
		//ITEM_AUX(Tile::glass_Id,GlassTile::TYPE_SOUL)
		ITEM_AUX(Tile::glass_Id,GlassTile::TYPE_QUICKSOIL)
		ITEM(Tile::packedGlass_Id)
	...
	DEF(eCreativeInventory_Misc)
		...
		ITEM(Tile::nusaCore_Id)
		ITEM(Tile::nusaCube_Id)
