...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM_AUX(Tile::dirt_Id, DirtTile::TYPE_AETHER)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_HOLYSTONE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_HOLYSTONE_MOSSY)
