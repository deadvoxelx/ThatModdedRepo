...
private:
	...
	UIControl_CheckBox m_checkboxClouds, m_checkboxBedrockFog, m_checkboxCustomSkinAnim, m_checkboxClassicTextures; // Checkboxes
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT( m_checkboxClassicTextures, "ClassicTextures")
