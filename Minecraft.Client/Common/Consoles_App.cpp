...
void CMinecraftApp::loadStringTable()
{
	...
	if (m_mediaArchive->hasFile(localisationFile))
	{
		...
		m_stringTable->registerString(IDS_RESET_END, L"Reset Aether"/*L"Reset End"*/);
		m_stringTable->registerString(IDS_DONT_RESET_END, L"Don't Reset Aether"/*L"Don't Reset End"*/);
