...
SheepuffFurModel::SheepuffFurModel() : QuadrupedModel(12, 0)
{
	headXRot = 0.0f;
...
void SheepuffFurModel::prepareMobModel(shared_ptr<LivingEntity> mob, float time, float r, float a)
{
...
void SheepuffFurModel::setupAnim(float time, float r, float bob, float yRot, float xRot, float scale, shared_ptr<Entity> entity, unsigned int uiBitmaskOverrideAnim)
{
