...
set(_MINECRAFT_CLIENT_COMMON_COMMON_UI_ALL_PLATFORMS
  ...
  #"${BASE_DIR}/UI/IUIScene_EnchanterMenu.cpp"
  #"${BASE_DIR}/UI/IUIScene_EnchanterMenu.h"
...
set(_MINECRAFT_CLIENT_COMMON_NET_MINECRAFT_CLIENT_MODEL
  "${CMAKE_CURRENT_SOURCE_DIR}/AerwhaleModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AerwhaleModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafBossModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafBossModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafPlantModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafPlantModel.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/EvupulModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/EvupulModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/FlyingCowModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/FlyingCowModel.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/MoaModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/MoaModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/ModelHorse.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/ModelHorse.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaDemonModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaDemonModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusagarModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusagarModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaSpikeModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaSpikeModel.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffFurModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffFurModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffModel.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/SunSpiritModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SunSpiritModel.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/CrystalModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/CrystalModel.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/ZephyrModel.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/ZephyrModel.h"
...
set(_MINECRAFT_CLIENT_COMMON_NET_MINECRAFT_CLIENT_RENDERER_ENTITY
  "${CMAKE_CURRENT_SOURCE_DIR}/AerwhaleRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AerwhaleRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafBossRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafBossRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafPlantRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/AphalafPlantRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/EvupulRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/EvupulRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/FlyingCowRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/FlyingCowRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/MoaRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/MoaRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/MobRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/MobRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/MoobloomRenderer.cpp"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaDemonRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaDemonRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusagarRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusagarRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaSpikeRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/NusaSpikeRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SheepuffRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/SunSpiritRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SunSpiritRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/CrystalRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/CrystalRenderer.h"
  "${CMAKE_CURRENT_SOURCE_DIR}/SwetRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/SwetRenderer.h"
  ...
  "${CMAKE_CURRENT_SOURCE_DIR}/ZephyrRenderer.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/ZephyrRenderer.h"
