...
HellFarlandsLevelSource::HellFarlandsLevelSource(Level *level, __int64 seed)
{
...
HellFarlandsLevelSource::~HellFarlandsLevelSource()
{
...
void HellFarlandsLevelSource::prepareHeights(int xOffs, int zOffs, byteArray blocks)
{
...
void HellFarlandsLevelSource::buildSurfaces(int xOffs, int zOffs, byteArray blocks)
{
...
LevelChunk *HellFarlandsLevelSource::create(int x, int z)
{
	return getChunk(x,z);
}

LevelChunk *HellFarlandsLevelSource::getChunk(int xOffs, int zOffs)
{
...
void HellFarlandsLevelSource::lightChunk(LevelChunk *lc)
{
	lc->recalcHeightmap();
}

doubleArray HellFarlandsLevelSource::getHeights(doubleArray buffer, int x, int y, int z, int xSize, int ySize, int zSize)
{
	if (buffer.data == NULL)
	{
...
bool HellFarlandsLevelSource::hasChunk(int x, int y)
{
	return true;
}

void HellFarlandsLevelSource::postProcess(ChunkSource *parent, int xt, int zt)
{
...
bool HellFarlandsLevelSource::save(bool force, ProgressListener *progressListener)
{
	return true;
}

bool HellFarlandsLevelSource::tick()
{
	return false;
}

bool HellFarlandsLevelSource::shouldSave()
{
	return true;
}

wstring HellFarlandsLevelSource::gatherStats()
{
	return L"HellFarlandsLevelSource";
}

vector<Biome::MobSpawnerData *> *HellFarlandsLevelSource::getMobsAt(MobCategory *mobCategory, int x, int y, int z)
{
...
TilePos *HellFarlandsLevelSource::findNearestMapFeature(Level *level, const wstring& featureName, int x, int y, int z)
{
	return NULL;
}

void HellFarlandsLevelSource::recreateLogicStructuresForChunk(int chunkX, int chunkZ)
{
