...
Tile *Tile::packedGlass = NULL;
Tile *Tile::endStoneButton = NULL;
//Tile *Tile::slimeBlock = NULL;
//Tile *Tile::barrier = NULL;
...
AetherPortalTile *Tile::aetherPortal = NULL;
...
//Tile *Tile::melonCarved = NULL;
//Tile *Tile::melonLit = NULL;
HalfSlabTile *Tile::stoneSlab2 = NULL;
HalfSlabTile *Tile::stoneSlab2Half = NULL;
...
void Tile::staticCtor()
{
	...
	Tile::flower = (FlowerTile *) (new FlowerTile(37))							->setDestroyTime(0.0f)->setSoundType(Tile::SOUND_GRASS)->setIconName(L"flower_dandelion")->setDescriptionId(IDS_TILE_FLOWER)->setUseDescriptionId(IDS_DESC_FLOWER)->disableMipmap();
	...
	Tile::tnt = (new TntTile(46))																->setBaseItemTypeAndMaterial(Item::eBaseItemType_tnt,	Item::eMaterial_tnt)->setDestroyTime(0.0f)->setSoundType(Tile::SOUND_GRASS)->setIconName(L"tnt")->setDescriptionId(IDS_TILE_TNT)->setUseDescriptionId(IDS_DESC_TNT);
	...
	Tile::obsidian = (new Tile(49, Material::obsidian))											->setDestroyTime(25.0f)->setExplodeable(1200)->setSoundType(Tile::SOUND_STONE)->setIconName(L"obsidian")->setDescriptionId(IDS_TILE_OBSIDIAN)->setUseDescriptionId(IDS_DESC_OBSIDIAN);
	...
	Tile::button = (new StoneButtonTile(77))					->setBaseItemTypeAndMaterial(Item::eBaseItemType_button,	Item::eMaterial_stone)->setDestroyTime(0.5f)->setSoundType(Tile::SOUND_STONE)->setIconName(L"button")->setDescriptionId(IDS_TILE_STONE_BUTTON)->sendTileData()->setUseDescriptionId(IDS_DESC_BUTTON);
	...
	Tile::fence = (new FenceTile(85, Tile::wood))						->setBaseItemTypeAndMaterial(Item::eBaseItemType_fence,	Item::eMaterial_wood)->setIconName(L"fence")->setDestroyTime(2.0f)->setSoundType(Tile::SOUND_WOOD)->setDescriptionId(IDS_TILE_FENCE)->setUseDescriptionId(IDS_DESC_FENCE);
	...
	Tile::stained_glass = (new StainedGlassBlock(95, Material::glass))->setBaseItemTypeAndMaterial(Item::eBaseItemType_glass,	Item::eMaterial_glass)->setDestroyTime(0.3f)->setSoundType(SOUND_GLASS)->setIconName(L"stainedGlass")->setDescriptionId(IDS_TILE_STAINED_GLASS)->setUseDescriptionId(IDS_DESC_STAINED_GLASS);
	...
	Tile::netherBrick = (new Tile(112, Material::netherrack))						->setBaseItemTypeAndMaterial(Item::eBaseItemType_structblock,	Item::eMaterial_netherbrick)->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(SOUND_STONE)->setIconName(L"nether_brick")->setDescriptionId(IDS_TILE_NETHERBRICK)->setUseDescriptionId(IDS_DESC_NETHERBRICK);
	Tile::netherFence = (new StoneFenceTile(113, Tile::netherBrick))			->setIconName(L"nether_brick")->setBaseItemTypeAndMaterial(Item::eBaseItemType_fence,		Item::eMaterial_netherbrick)->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(SOUND_STONE)->setDescriptionId(IDS_TILE_NETHERFENCE)->setUseDescriptionId(IDS_DESC_NETHERFENCE);
	Tile::stairs_netherBricks = (new StairTile(114, Tile::netherBrick,0))		->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,	Item::eMaterial_netherbrick)->setExplodeable(10)->setIconName(L"stairsNetherBrick")->setDescriptionId(IDS_TILE_STAIRS_NETHERBRICK)	->sendTileData()->setUseDescriptionId(IDS_DESC_STAIRS);
	...
	Tile::endStone = (new EndStoneTile(121))									->setBaseItemTypeAndMaterial(Item::eBaseItemType_structblock,	Item::eMaterial_endStone)->setDestroyTime(3.0f)->setExplodeable(15)->setSoundType(SOUND_STONE)->setIconName(L"end_stone")->setDescriptionId(IDS_TILE_WHITESTONE)->setUseDescriptionId(IDS_DESC_WHITESTONE);
	...
	Tile::button_wood =		(new WoodButtonTile(143))				->setBaseItemTypeAndMaterial(Item::eBaseItemType_button,	Item::eMaterial_wood)->setDestroyTime(0.5f)->setSoundType(Tile::SOUND_WOOD)->setIconName(L"button")->setDescriptionId(IDS_TILE_WOOD_BUTTON)->sendTileData()->setUseDescriptionId(IDS_DESC_BUTTON);
	...
	Tile::netherQuartz =	(new OreTile(153))								->setDestroyTime(3.0f)->setExplodeable(10)->setSoundType(SOUND_STONE)->setIconName(L"quartz_ore")->setDescriptionId(IDS_TILE_NETHER_QUARTZ)->setUseDescriptionId(IDS_DESC_NETHER_QUARTZ_ORE);
	...
	Tile::quartzBlock =		(new QuartzBlockTile(155))						->setBaseItemTypeAndMaterial(Item::eBaseItemType_structblock,	Item::eMaterial_quartz)->setExplodeable(10)->setSoundType(SOUND_STONE)->setDestroyTime(0.8f)->setIconName(L"quartz_block")->setDescriptionId(IDS_TILE_QUARTZ_BLOCK)->setUseDescriptionId(IDS_DESC_QUARTZ_BLOCK);
	Tile::stairs_quartz =	(new StairTile(156, Tile::quartzBlock, QuartzBlockTile::TYPE_DEFAULT))	->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,	Item::eMaterial_quartz)->setExplodeable(10)->setIconName(L"stairsQuartz")->setDescriptionId(IDS_TILE_STAIRS_QUARTZ)->setUseDescriptionId(IDS_DESC_STAIRS);
	...
	Tile::stained_glass_pane = (new StainedGlassPaneBlock(160))				->setBaseItemTypeAndMaterial(Item::eBaseItemType_glass,	Item::eMaterial_glass)->setDestroyTime(0.3f)->setSoundType(SOUND_GLASS)->setIconName(L"stainedGlass")->setDescriptionId(IDS_TILE_STAINED_GLASS_PANE)->setUseDescriptionId(IDS_DESC_STAINED_GLASS_PANE);
	...
	Tile::netherDiamond = (new OreTile(174))							->setDestroyTime(3.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"nether_diamond")->setDescriptionId(IDS_TILE_NETHER_DIAMOND)->setUseDescriptionId(IDS_DESC_NETHER_DIAMOND);
	Tile::netherGold = (new OreTile(175))								->setDestroyTime(3.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"nether_gold")->setDescriptionId(IDS_TILE_NETHER_GOLD)->setUseDescriptionId(IDS_DESC_NETHER_GOLD);
	Tile::goldenclin = (new GoldenclinTile(176))						->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"goldenclin")->setDescriptionId(IDS_TILE_GOLDENCLIN)->setUseDescriptionId(IDS_DESC_GOLDENCLIN);
	...
	Tile::nethaniumBlock = (new MetalTile(186))							->setBaseItemTypeAndMaterial(Item::eBaseItemType_block,	Item::eMaterial_nethanium)->setDestroyTime(5.0f)->setExplodeable(1200)->setSoundType(Tile::SOUND_METAL)->setIconName(L"nethanium_block")->setDescriptionId(IDS_TILE_NETHANIUMBLOCK)->setUseDescriptionId(IDS_DESC_NETHANIUMBLOCK);
	...
	//Tile::mossyEndStoneStairs = (new StairTile(191, Tile::endStoneBlock, EndStoneTile::TYPE_MOSSY))->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,	Item::eMaterial_endStone)->setDestroyTime(3.0f)->setExplodeable(15)->setSoundType(Tile::SOUND_STONE)->setIconName(L"end_stone")->setDescriptionId(IDS_TILE_WHITESTONE)->setUseDescriptionId(IDS_DESC_WHITESTONE);
 	//Tile::endBrickStairs = (new StairTile(192, Tile::endStoneBlock, EndStoneTile::TYPE_BRICK))->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,	Item::eMaterial_endStone)->setDestroyTime(3.0f)->setExplodeable(15)->setSoundType(Tile::SOUND_STONE)->setIconName(L"end_stone")->setDescriptionId(IDS_TILE_WHITESTONE)->setUseDescriptionId(IDS_DESC_WHITESTONE);
	//Tile::mossyEndBrickStairs = (new StairTile(193, Tile::endStoneBlock, EndStoneTile::TYPE_MOSSY_BRICK))->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,	Item::eMaterial_endStone)->setDestroyTime(3.0f)->setExplodeable(15)->setSoundType(Tile::SOUND_STONE)->setIconName(L"end_stone")->setDescriptionId(IDS_TILE_WHITESTONE)->setUseDescriptionId(IDS_DESC_WHITESTONE);
	...
	Tile::endoriumBlock = (new MetalTile(198))							->setBaseItemTypeAndMaterial(Item::eBaseItemType_block,	Item::eMaterial_endorium)->setDestroyTime(5.0f)->setExplodeable(1200)->setSoundType(Tile::SOUND_METAL)->setIconName(L"endorium_block")->setDescriptionId(IDS_TILE_ENDORIUMBLOCK)->setUseDescriptionId(IDS_DESC_NETHANIUMBLOCK);
	...
	Tile::stoneSlab2Half = (HalfSlabTile *) (new StoneSlab2Tile(Tile::stoneSlab2Half_Id, false))->setBaseItemTypeAndMaterial(Item::eBaseItemType_halfslab,	Item::eMaterial_stone)->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"stoneSlab")->setDescriptionId(IDS_TILE_STONESLAB)->setUseDescriptionId(IDS_DESC_HALFSLAB);

	Tile::skyrootLog = (new NetherWoodTile(215))						->setDestroyTime(2.0f)->setSoundType(SOUND_WOOD)->setIconName(L"skyrootLog")->setDescriptionId(IDS_TILE_SKYROOT_LOG)->setUseDescriptionId(IDS_TILE_SKYROOT_LOG);
	Tile::goldenOakLog = (new GoldenOakTile(216))						->setDestroyTime(2.0f)->setSoundType(SOUND_WOOD)->setIconName(L"goldenOakLog")->setDescriptionId(IDS_TILE_GOLDENOAK_LOG)->setUseDescriptionId(IDS_TILE_GOLDENOAK_LOG);
	Tile::skyrootSapling = (Bush *) (new AetherSaplingTile(217))		->setDestroyTime(0.0f)->setSoundType(Tile::SOUND_GRASS)->setIconName(L"skyrootSapling")->setDescriptionId(IDS_TILE_SKYROOT_SAPLING)->setUseDescriptionId(IDS_TILE_SKYROOT_SAPLING)->disableMipmap();
	Tile::goldenOakSapling = (Bush *) (new AetherSaplingTile(218))		->setDestroyTime(0.0f)->setSoundType(Tile::SOUND_GRASS)->setIconName(L"goldenOakSapling")->setDescriptionId(IDS_TILE_GOLDENOAK_SAPLING)->setUseDescriptionId(IDS_TILE_GOLDENOAK_SAPLING)->disableMipmap();
	...
	Tile::gravititeOre = (new OreTile(221))								->setDestroyTime(1.5f)->setExplodeable(120)->setSoundType(Tile::SOUND_STONE)->setIconName(L"gravititeOre")->setDescriptionId(IDS_TILE_GRAVITITE_ORE)->setUseDescriptionId(IDS_TILE_GRAVITITE_ORE);
	...
	Tile::enchantedGravitite = (new EnchantedGravititeTile(227))		->setBaseItemTypeAndMaterial(Item::eBaseItemType_block,	Item::eMaterial_gravitite)->setDestroyTime(5.0f)->setExplodeable(120)->setSoundType(Tile::SOUND_METAL)->setIconName(L"iron_block")->setDescriptionId(IDS_TILE_ENCHANTED_GRAVITITE)->setUseDescriptionId(IDS_TILE_ENCHANTED_GRAVITITE);
