...
#ifdef __PSVITA__
int64_t BiomeSource::findSeed(LevelType *generator, bool* pServerRunning, int worldSizeChunks)	// MGH - added pRunning, so we can early out of this on Vita as it can take up to 60 secs
#else
