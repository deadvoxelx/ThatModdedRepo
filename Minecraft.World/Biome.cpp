...
void Biome::staticCtor()
{
	...
	Biome::extremeHills = (new ExtremeHillsBiome(3))->setColor(0x056621)->setName(L"Extreme Hills")->setLeafColor(0x4EBA31)->setDepthAndScale(0.1f, 2)->setTemperatureAndDownfall(0.2f, 0.3f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Forest, eMinecraftColour_Foliage_Forest, eMinecraftColour_Water_ExtremeHills,eMinecraftColour_Sky_ExtremeHills);
	...
	Biome::smallerExtremeHills = (new ExtremeHillsBiome(20))->setColor(0x056621)->setName(L"Extreme Hills Edge")->setLeafColor(0x4EBA31)->setDepthAndScale(0.1f, 1.5f)->setTemperatureAndDownfall(0.2f, 0.3f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Forest, eMinecraftColour_Foliage_Forest, eMinecraftColour_Water_ExtremeHillsEdge,eMinecraftColour_Sky_ExtremeHillsEdge);
