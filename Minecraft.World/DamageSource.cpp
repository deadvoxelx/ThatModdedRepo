...
DamageSource *DamageSource::dart(shared_ptr<Dart> dart, shared_ptr<Entity> owner)
{
...
DamageSource *DamageSource::dartNethanium(shared_ptr<DartNethanium> dartN, shared_ptr<Entity> owner)
{
	return (new IndirectEntityDamageSource(ChatPacket::e_ChatDeathArrow, ChatPacket::e_ChatDeathArrowItem, dartN, owner))->setProjectile();
}
