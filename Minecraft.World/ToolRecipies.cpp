...
void ToolRecipies::_init()
{
	...
	ADD_OBJECT(map[0],Tile::netherPlanks);
	...
	ADD_OBJECT(map[1],Item::skyrootPickaxe);
	...
	ADD_OBJECT(map[2],Item::skyrootShovel);
	...
	ADD_OBJECT(map[3],Item::skyrootAxe);
	...
	ADD_OBJECT(map[4],Item::skyrootHoe);
