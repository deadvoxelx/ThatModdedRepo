...
enum eINSTANCEOF
{
	...
	eTYPE_MOB		= eTYPE_LIVINGENTITY | BIT_MOB,
			...
			eTYPE_PATHFINDER_MOB	= eTYPE_MOB | BIT_PATHFINDER_MOB,
					...
					eTYPE_MONSTER     =	eTYPE_ENEMY | eTYPE_PATHFINDER_MOB | BIT_MONSTER,
						...
						eTYPE_EVUPULDARK		= eTYPE_MONSTER | eTYPE_VALID_IN_SPAWNER_FLAG | 0x11,
						...
						eTYPE_FIRE_MINION		= eTYPE_MONSTER	| eTYPE_VALID_IN_SPAWNER_FLAG | 0x22,
						eTYPE_NUSAGAR			= eTYPE_MONSTER	| eTYPE_VALID_IN_SPAWNER_FLAG | 0x23,


				eTYPE_AMBIENT				= eTYPE_MOB | BIT_AMBIENT_MOB,
					eTYPE_BAT				= eTYPE_AMBIENT | eTYPE_VALID_IN_SPAWNER_FLAG | 0x1,
					eTYPE_COCKATRICESPAWNER	= eTYPE_AMBIENT | eTYPE_VALID_IN_SPAWNER_FLAG | 0x2,
					eTYPE_NUSA_SPIKE		= eTYPE_AMBIENT | eTYPE_VALID_IN_SPAWNER_FLAG | 0x3,
	...
	eTYPE_DARTENCHANTED			= (eTYPE_OTHER_ENTITIES + 16) | eTYPE_PROJECTILE,
	eTYPE_DARTPOISON			= (eTYPE_OTHER_ENTITIES + 17) | eTYPE_PROJECTILE,
	eTYPE_DARTNETHANIUM			= (eTYPE_OTHER_ENTITIES + 18) | eTYPE_PROJECTILE,
	eTYPE_CRYSTAL				= (eTYPE_OTHER_ENTITIES + 19) | eTYPE_PROJECTILE,
...
#define SUBCLASS(x) (new SubClass( #x , x ))
	...
	static void checkDerivations()
	{
		...
		classes->push_back( SUBCLASS(eTYPE_FIRE_MINION			)->addParent( eTYPE_MONSTER )->addParent(eTYPE_VALID_IN_SPAWNER_FLAG) );
		classes->push_back( SUBCLASS(eTYPE_NUSAGAR				)->addParent( eTYPE_MONSTER )->addParent(eTYPE_VALID_IN_SPAWNER_FLAG) );
		classes->push_back( SUBCLASS(eTYPE_NUSA_SPIKE			)->addParent( eTYPE_AMBIENT )->addParent(eTYPE_VALID_IN_SPAWNER_FLAG ) );
		...
		classes->push_back( SUBCLASS(eTYPE_DARTPOISON			)->addParent( eTYPE_ENTITY )->addParent(eTYPE_PROJECTILE ) );
		classes->push_back( SUBCLASS(eTYPE_DARTENCHANTED		)->addParent( eTYPE_ENTITY )->addParent(eTYPE_PROJECTILE ) );
		classes->push_back( SUBCLASS(eTYPE_DARTNETHANIUM		)->addParent( eTYPE_ENTITY )->addParent(eTYPE_PROJECTILE ) );
		classes->push_back( SUBCLASS(eTYPE_CRYSTAL				)->addParent( eTYPE_ENTITY )->addParent(eTYPE_PROJECTILE ) );
